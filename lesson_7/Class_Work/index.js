...
// функция которая принимает первым аргументом принимает действие (сумма, вычитание), после принимает параметры для вычисления
...
//   return result;
// };
// console.log(someArgs(1, 2, 4, -6, 2, 8, 9));  // 10
